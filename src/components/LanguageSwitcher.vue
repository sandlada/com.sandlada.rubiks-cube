<template>
  <div
    class="lang-switch flex w-full flex-col gap-2"
    role="group"
  ...
  >
    ...
    <div class="grid grid-cols-2 border border-black/15 dark:border-white/15">
      <button
        ...
        class="min-h-[40px] px-4 text-center text-[11px] font-medium uppercase tracking-[0.25em] transition-colors"
        :class="isActive(entry.code) ? 'bg-black text-white dark:bg-white dark:text-black' : 'text-neutral-600 hover:bg-black/5 hover:text-neutral-900 dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white'"
