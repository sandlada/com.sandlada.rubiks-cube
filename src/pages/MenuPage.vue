<template>
  <main class="flex min-h-dvh w-full items-center justify-center bg-white px-6 py-12 text-neutral-900 dark:bg-[#050505] dark:text-white">
    <div class="flex w-full max-w-md flex-col items-stretch gap-8 text-center">
      ...
      <section class="flex flex-col gap-2" :aria-label="t('game.sizeLabel')">
      ...
      <section class="flex flex-col gap-2" :aria-label="t('game.difficultyLabel')">
        <p class="text-[11px] font-light uppercase tracking-[0.3em] text-neutral-500 dark:text-white/50">
      ...
      <footer class="flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
        <LanguageSwitcher />
        <ThemeToggle />
      </footer>
    </div>
